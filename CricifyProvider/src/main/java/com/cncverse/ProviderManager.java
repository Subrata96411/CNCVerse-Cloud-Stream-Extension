                    ...
                    if (!(str == null || StringsKt.isBlank(str))) {
                        ...
                        if (!(str2 == null || StringsKt.isBlank(str2))) {
                            ...
                            if (deserializationStrategy != null) {
                                ...
                                c2 = 0;
                                objDecodeFromString = $this$readValue$iv$iv22.readValue(decryptedData, new TypeReference<List<? extends ProviderData>>() { // from class: com.cncverse.ProviderManager$fetchProviders$2$invokeSuspend$$inlined$parseJson$1
                                });
                            }
                    ...
                    if (!(str == null || StringsKt.isBlank(str))) {
                        ...
                        if (!(str2 == null || StringsKt.isBlank(str2))) {
                            ...
                            if (deserializationStrategy != null) {
                                ...
                                ObjectMapper $this$readValue$iv$iv22 = MainAPIKt.getMapper();
                                objDecodeFromString = $this$readValue$iv$iv22.readValue(decryptedData, new TypeReference<List<? extends LiveEventData>>() { // from class: com.cncverse.ProviderManager$fetchLiveEvents$2$invokeSuspend$$inlined$parseJson$1
                                });
                            }
