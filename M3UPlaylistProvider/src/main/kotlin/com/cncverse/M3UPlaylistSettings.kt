...
/**
 * Settings bottom sheet for M3UPlaylistProvider.
 *
 * Allows the user to:
 ...
 */
class M3UPlaylistSettings(
    private val plugin            : M3UPlaylistPlugin,
    private val prefs             : SharedPreferences,
    private val onPlaylistsChanged: () -> Unit
) : BottomSheetDialogFragment() {

    private val playlists = M3UPlaylistPlugin
    ...
    private fun saveAndPromptRestart() {
        val ctx = activity ?: return
        M3UPlaylistPlugin.savePlaylists(prefs, playlists)
        onPlaylistsChanged()
